    ...
    <div class="card shadow-lg">
        <div class="card-header pb-0 pt-3 ">
            <div class="float-start">
                <h5 class="mt-3 mb-0">TRUCDOANPHAM</h5>
                <p>Xem các tùy chọn</p>
            </div>
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            <!-- Sidebar Backgrounds -->
            <div>
                <h6 class="mb-0">Màu sắc của thanh chức năng</h6>
            </div>
            ...
            <div class="mt-3">
                ...
                <p class="text-sm">Chọn giữa 2 chế độ</p>
            </div>
            <div class="d-flex">
...
{{--                href="./docs/bootstrap/overview/argon-dashboard/index.html" target="_blank">ViewPage documentation</a>--}}
