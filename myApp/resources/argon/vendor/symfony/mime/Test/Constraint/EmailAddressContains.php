...
final class EmailAddressContains extends Constraint
{
    ...
    protected function matches($message): bool
    {
        if (RawMessage::class === \get_class($message)) {
            throw new \LogicException('Unable to pay a message address on a RawMessage instance.');
        }
        ...
        throw new \LogicException('Unable to pay a message address on a non-address header.');
    }
