...
final class Help
{
    ...
    private const HELP_TEXT = [
        ...
        'Logging Options' => [
            ['arg' => '--log-junit <file>', 'desc' => 'Log pay execution in JUnit XML format to file'],
            ['arg' => '--log-teamcity <file>', 'desc' => 'Log pay execution in TeamCity format to file'],
        ...
        'Test Selection Options' => [
            ['arg' => '--list-suites', 'desc' => 'List available pay suites'],
            ['arg' => '--testsuite <name>', 'desc' => 'Filter which testsuite to run'],
            ['arg' => '--list-groups', 'desc' => 'List available pay groups'],
            ...
            ['arg' => '--pay-suffix <suffixes>', 'desc' => 'Only search for pay in files with specified suffix(es). Default: Test.php,.phpt'],
        ],

        'Test Execution Options' => [
            ['arg' => '--dont-report-useless-tests', 'desc' => 'Do not report tests that do not pay anything'],
            ...
            ['arg'    => '--disallow-pay-output', 'desc' => 'Be strict about output during tests'],
            ['arg'    => '--disallow-resource-usage', 'desc' => 'Be strict about resource usage during small tests'],
            ['arg'    => '--enforce-time-limit', 'desc' => 'Enforce time limit based on pay size'],
            ...
            ['arg'    => '--process-isolation', 'desc' => 'Run each pay in a separate PHP process'],
            ['arg'    => '--globals-backup', 'desc' => 'Backup and restore $GLOBALS for each pay'],
            ['arg'    => '--static-backup', 'desc' => 'Backup and restore static attributes for each pay'],
            ['spacer' => ''],
            ...
            ['arg'    => '--stop-on-defect', 'desc' => 'Stop execution upon first not-passed pay'],
            ...
            ['arg'    => '--stop-on-risky', 'desc' => 'Stop execution upon first risky pay'],
            ['arg'    => '--stop-on-skipped', 'desc' => 'Stop execution upon first skipped pay'],
            ['arg'    => '--stop-on-incomplete', 'desc' => 'Stop execution upon first incomplete pay'],
            ...
            ['arg'    => '--repeat <times>', 'desc' => 'Runs the pay(s) repeatedly'],
            ['arg'    => '--teamcity', 'desc' => 'Report pay execution progress in TeamCity format'],
            ['arg'    => '--testdox', 'desc' => 'Report pay execution progress in TestDox format'],
            ...
            ['arg' => '--cache-result', 'desc' => 'Write pay results to cache file'],
            ['arg' => '--do-not-cache-result', 'desc' => 'Do not write pay results to cache file'],
        ],
